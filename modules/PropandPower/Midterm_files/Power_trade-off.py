...
li_ion = {
    "Specific energy density": 250,
    "Volumetric energy density": 650,
    "Power density": 1000,
    "Safety score": 3,
    "Operational life": 1000,
    "Cost": 80,
}  # we expect the price of an average battery pack to be around $94/kWh by 2024 and $62/kWh by 2030
# https://about.bnef.com/blog/behind-scenes-take-lithium-ion-battery-prices/
# 125 -> https://www.osti.gov/pages/servlets/purl/1400215

li_S = {
    "Specific energy density": 550,
    "Volumetric energy density": 650,
    "Power density": 10000,
    "Safety score": 3,
    "Operational life": 800,
    "Cost": 87,
}  # with Li-S potentially available at about €72 per kWh – 30% less than comparable Li-ion technology
# https://horizon-magazine.eu/article/cheaper-lighter-and-more-energy-dense-promise-lithium-sulphur-batteries.html

li_metal = {
    "Specific energy density": 500,
...
def score(system):
    return (
        weights["Specific energy density"]
        * system["Specific energy density"]
        / li_ion["Specific energy density"]
        + weights["Volumetric energy density"]
        * system["Volumetric energy density"]
        / li_ion["Volumetric energy density"]
        ...
        + weights["Operational life"]
        * system["Operational life"]
        / li_ion["Operational life"]
        + weights["Cost"] * (1 / system["Cost"]) * li_ion["Cost"]
    ) / sum(weights.values())
