...
print(
    "The propeller noise at cruise at",
    r * 0.3048,
    "m from the propeller is",
    Noise_cruise,
    "dB",
)

print(
    "The propeller noise at cruise at 1 m from the propeller is", Noise_cruise_1m, "dB"
)
print("")
...
print(
    "Noise level in cruise at",
    r * 0.3048,
    "m from the propeller, total:",
    sum_noise(np.ones((1, 12))[0] * Noise_cruise),
    "[dB]",
)
print("")
...
midterm_noise = noise_midterm.Noise(
    P_br / 1000, P_h / 12, D, B, 12, 12, rpm_h, rpm_cr, a, M_tip_h, M_tip
)

print(
    "The propeller noise in cruise at 1 metre from the propeller is",
    midterm_noise.SPL_cr(),
)
print(
    "The propeller noise in hover at 1 metre from the propeller is",
    midterm_noise.SPL_hover(),
)
