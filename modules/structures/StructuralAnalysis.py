...
inputs = dict(
    MAC=1.265147796494402,  # Mean Aerodynamic Chord [m]
...
state = dict(
    nStrT=2,
    nStrB=1,
    thicknessOfSkin=1e-3,
    thicknessOfSpar=18 * 1e-3,
    thicknessOfStringer=1e-3,
    ntofit=20,
    stringerMat=dict(material="Al 7075", Condition="T6"),
