...
def weissinger_l(wing, al, al_fore, m):
    ...
    if wing.tandem == "fore":
        ...
        al = al * pi / 180.0  # Fore wing -> single AOA input
        ...
        al = al * pi / 180.0  # Fore Wing AOA
        al_fore = al_fore * pi / 180.0  # Fore Wing induced AOA array
        al = -al_fore + al
    ...
    return y * wing.span / 2.0, cl, ccl, al_i, CL, CDi, c
...
if __name__ == "__main__":
    ...
    y2, cl2, ccl2, al_i2, CL2, CDi2, c2 = weissinger_l(
        wing2, alpha, downwash_fore(c, y, cl, 6, 1.25, 1), 2 * npoints - 1
    )  # alpha, al_i
