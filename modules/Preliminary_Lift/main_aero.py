...
from Preliminary_Lift.LLTtest2 import (
    LLT1wing,
    LLT2wings,
    downwash,
    downwash_upwash,
...
CD_a_w = Wing_params.CDa_poststall(
    tca, CDs_w, CDs_f, Afus, alpha_lst, "wing", Drag.CD, deda
)
CD_a_f = Wing_params.CDa_poststall(
    tca, CDs_w, CDs_f, Afus, alpha_lst, "fus", Drag.CD, deda
)
...
CLwp = Wing_params.CLa_wprop(
    T, Vcruise, rho, D, ne1, ne2, tc, CDs_w, CDs_f, Afus, alpha_wp, deda
)
