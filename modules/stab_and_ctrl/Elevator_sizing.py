...
class Elevator_sizing:
    def __init__(
        ...
        self.Cmacfwd, self.Cmacrear = (
            Cm_ac(self.Sweepc4fwd, self.Afwd)[0],
            Cm_ac(self.Sweepc4rear, self.Arear)[0],
        )
        ...
        # self.Sa_S = Sa_S
        self.Clafwd, self.Clarear, self.Cd0fwd, self.Cd0rear = (
            Clafwd,
            Clarear,
            Cd0fwd,
            Cd0rear,
    ...
    def Cm(self, Se_S, be_b, de_max):
        ...
        Cm = (
            -CDfwd * (self.zcg - self.dy) * self.Sfwd / (self.S * self.c)
            + (self.CLfwd + self.dCLfwd_f(Se_S, be_b, de_max))
            * (self.xcg - self.xacfwd)
            * self.Sfwd
            / (self.S * self.c)
            + CDrear
            * (self.hfus - self.zcg)
            * self.Srear
            / (self.S * self.c)
            * self.eta_rear
            - (self.CLrear + self.dCLrear(Se_S, be_b, de_max))
            * (self.xacrear - self.xcg)
            * self.Srear
            / (self.S * self.c)
            * self.eta_rear
            + self.Cmacfwd * self.Sfwd * self.cfwd / (self.S * self.c)
            + self.Cmacrear
            * self.Srear
            * self.crear
            / (self.S * self.c)
    ...
    def plotting(self, Se_S, be_b, ce_c, de_max):
        ...
        if isinstance(be_b, float) and not isinstance(Se_S, float):
            ...
            dCL_array = (
                self.tau_e(Se_S) * self.CLafwd * be_b * de_max * np.pi / 180 / 100
            )
