...
plt.legend()
plt.grid(alpha=0.7)
plt.savefig(os.path.join(os.path.expanduser("~"), "Downloads", "halfnormal_plot.pdf"), bbox_inches= "tight" )
...
plt.legend()
plt.grid(alpha=0.7)
plt.savefig(os.path.join(os.path.expanduser("~"), "Downloads", "genextreme_plot.pdf"), bbox_inches= "tight" )
