...
c_pp = (
    0.3  # [m] Horizontal clearance between the propellers (closest point, tip to tip)
)
...
eff_bat_eng_cr = (
    0.9  # Efficiency from the battery to the engines (including both) in cruise
)
eff_bat_eng_h = (
    0.75  # Efficiency from the battery to the engines (including both) in hover
)
...
TW_ratio_control = (
    1.5  # Thrust-to-weight ratio needed for the aircraft to be controllable in hover
)
